      ...
      const savedDestinationData = {
        ...
        lieux:
          selectedItems.lieux.length > 0
            ...
            : null,
        activites:
          selectedItems.activites.length > 0
  ...
  useEffect(() => {
    const fetchFormData = async () => {
      try {
        ...
        if (destError) {
          console.error(
            "❌ Erreur lors de la récupération de l'ID de destination:",
            destError
          );
        ...
        if (!destData) {
          console.warn(
            `⚠️ Aucune destination trouvée pour ${formattedDestination}`
          );
          return;
        }
        ...
        logAndSetArray(
          descData.restaurant?.restaurants,
          "Restaurants",
          setRestos
        );
      } catch (error) {
    ...
    <>
      ...
      <header className="py-3 sm:py-4 md:py-5 px-4 sm:px-6 md:px-8 flex justify-between items-center">
        ...
        <div className="flex items-center">
          <Link
            to="/profile"
            className="text-black hover:text-[#9557fa] transition-colors text-sm sm:text-base"
          >
            Mon Profil
          </Link>
        </div>
      ...
      <main>
        <div>
          ...
          {banner && (
            <div className="relative w-full h-screen/3 overflow-hidden">
              ...
              <div className="absolute rounded-2xl top-1/2 left-[10%] backdrop-blur-lg px-3 py-1 transform -translate-y-1/2 text-center">
                ...
                <p className="text-4xl text-left font-bold text-[#FA9B3D]">
                  {destination}
                </p>
              </div>
            </div>
          ...
          <div className="rounded-2xl p-4 shadow-lg w-[90%] mx-auto mb-10 mt-10">
            <h1 className="text-[#9557fa] text-4xl text-left font-bold mb-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="p-4">
                <h3 className="text-lg text-left font-bold mb-3">
                  Informations pratiques :
                </h3>
                ...
                {infoPratiques ? (
                  <>
                    <div className="mb-1">
                      ...
                      <p className="text-sm bg-red-200 break-words w-full">{infoPratiques.ideal_pour?.join(", ") || "Non disponible"}</p> */}
                        <p className="text-sm text-left break-words">
                          <span className="text-[#9557fa] font-bold text-sm mr-1 whitespace-nowrap">
                            Idéal pour :{" "}
                          </span>
                          {infoPratiques.ideal_pour?.join(", ") ||
                            "Non disponible"}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="mb-1">
                      <div className="flex flex-wrap items-start">
                        <p className="text-sm text-left break-words">
                          ...
                          {infoPratiques.decalage_horaire || "Non disponible"}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="mb-1">
                      <p className="text-[#9557fa] text-left font-bold text-sm mb-1">
                        Températures :
                      </p>
                      <ul className="list-none pl-5">
                        <li className="relative pl-7 text-xl text-left before:content-['•'] before:absolute before:left-0 before:text-[#9557fa] leading-tight">
                          <span className="text-sm">
                            Été :{" "}
                            {infoPratiques.temperatures?.ete ||
                              "Non disponible"}
                          </span>
                        </li>
                        <li className="relative pl-7 text-xl text-left before:content-['•'] before:absolute before:left-0 before:text-[#9557fa] leading-tight">
                          <span className="text-sm">
                            Hiver :
                            {infoPratiques.temperatures?.hiver ||
                              "Non disponible"}
                          </span>
                        </li>
                        <li className="relative pl-7 text-xl text-left before:content-['•'] before:absolute before:left-0 before:text-[#9557fa] leading-tight">
                          <span className="text-sm">
                            Automne :{" "}
                            {infoPratiques.temperatures?.automne ||
                              "Non disponible"}
                          </span>
                        </li>
                        <li className="relative pl-7 text-xl text-left before:content-['•'] before:absolute before:left-0 before:text-[#9557fa] leading-tight">
                          <span className="text-sm">
                            Printemps :{" "}
                            {infoPratiques.temperatures?.printemps ||
                              "Non disponible"}
                          </span>
                        </li>
                      </ul>
                    ...
                    <div className="mb-1">
                      <div className="flex flex-wrap items-start">
                        <p className="text-sm text-left break-words">
                          ...
                          {infoPratiques.incontournables?.join(", ") ||
                            "Non disponible"}
                        </p>
                      </div>
                    </div>
                      ...
                      <div className="mb-1">
                        <div className="flex flex-wrap items-start">
                          <p className="text-sm text-left break-words">
                            ...
                            {santeEtSecurite.se_deplacer?.join(", ") ||
                              "Non disponible"}
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="mb-1">
                        <div className="flex flex-wrap items-start">
                          <p className="text-sm text-left break-words">
                            ...
                            {santeEtSecurite.assurance?.join(", ") ||
                              "Non disponible"}
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="mb-1">
                      ...
                      <ul className="list-none pl-5">
                        <li className="relative pl-7 text-xl text-left before:content-['•'] before:absolute before:left-0 before:text-[#9557fa] leading-tight">
                          <span className="text-sm">
                            Budget routard :{" "}
                            {budget.budget_routard_par_jour || "Non disponible"}{" "}
                            /jour
                          </span>
                        </li>
                        <li className="relative pl-7 text-xl text-left before:content-['•'] before:absolute before:left-0 before:text-[#9557fa] leading-tight">
                          <span className="text-sm">
                            Budget confort :{" "}
                            {budget.budget_confort_par_jour || "Non disponible"}{" "}
                            /jour
                          </span>
                        </li>
                        <li className="relative pl-7 text-xl text-left before:content-['•'] before:absolute before:left-0 before:text-[#9557fa] leading-tight">
                          <span className="text-sm">
                            Budget luxe :{" "}
                            {budget.budget_luxe_par_jour || "Non disponible"}{" "}
                            /jour
                          </span>
                        </li>
                      </ul>
                    ...
                    <div className="mb-1">
                      ...
                      <ul className="list-none pl-5">
                        {gastronomie.specialites?.map((specialite, index) => (
                          <li
                            key={index}
                            className="relative pl-7 text-xl text-left before:content-['•'] before:absolute before:left-0 before:text-[#9557fa] leading-tight"
                          >
          ...
          <div className="rounded-2xl p-4 shadow-lg w-[90%] mx-auto mb-10 mt-10">
            <div className="flex">
              ...
              <div className="w-2/3">
                <h1 className="text-[#9557fa] text-4xl text-left -mt-4 -mb-4 pl-[10%] font-bold">
                  Lieux
                </h1>
                <HotelCarousel
                  hotels={lieux}
                ...
                <h1 className="text-[#9557fa] text-4xl -mt-4 -mb-4 text-left pl-[10%] font-bold">
                  Hotels
                </h1>
                <HotelCarousel
                  hotels={hotels}
              ...
              <div className="w-1/3 flex flex-col space-y-4">
                ...
                <div className="flex-1 bg-white p-1 ml-5 mt-10 rounded-lg bg-gradient-to-r from-[#9557fa] to-[#fa9b3d] shadow-sm flex items-center justify-center">
                  <div className="p-6 rounded-xl bg-white w-full h-full">
                    <div
                      className="flex-1 bg-gradient-to-r from-[#9557fa] to-[#fa9b3d] h-full p-4 rounded-lg border border-gray-200 shadow-sm flex items-center justify-center"
                      style={{ backdropFilter: "blur(8px)" }}
                    >
                      <div className="text-center bg-white/30 backdrop-blur-xl p-4 rounded-lg">
                        <h3 className="text-2xl font-bold text-[#9557fa] mb-2">
                          Arrive Prochainement !
                        </h3>
                        <p className="text-gray-600">
                          Notre carte interactive sera bientôt disponible
                        </p>
                      </div>
                    </div>
                  </div>
