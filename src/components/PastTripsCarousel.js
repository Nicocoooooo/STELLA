...
function PastTripsCarousel({ trips }) {
  ...
  useEffect(() => {
    const timer = setInterval(() => {
      setCurrentIndex((current) => (current + 1) % trips.length);
    }, 5000);
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      {/* Points de pagination - Responsif */}
